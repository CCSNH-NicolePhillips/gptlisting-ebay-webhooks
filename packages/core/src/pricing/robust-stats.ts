 ...
 * Requires ≥10 cleaned sold comps so that P35 has statistical reliability.
 * Products with 3-9 cleaned samples fall into the WEAK tier (median/P50 pricing).
 */
...
/**
 * Sold data is "weak" — 3-9 cleaned samples. Enough for conservative median pricing (P50)
 * but not enough for aggressive P35 (which requires ≥10). Better than falling through to retail × 0.70.
 */
