/**
 * DEPRECATED: Legacy Express app - NOT USED
 ...
 * @see netlify/functions/ for current implementation
 */
...
//   try {
//     res.json(await listPolicies('demo'));
//   } catch (e: any) {
//     res.status(500).json({ error: e.message });
//   }
// });
...
//   try {
//     res.json(await listInventoryLocations('demo'));
//   } catch (e: any) {
//     res.status(500).json({ error: e.message });
//   }
// });
