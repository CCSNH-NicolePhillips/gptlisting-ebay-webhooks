...
async function analyzeBatchViaVision(
  ...
  const prompt = [
    ...
    "",
    "Step 4 — COLOR & VISUAL DESCRIPTION:",
    "• hasVisibleText (true/false)",
    "• dominantColor (specific shade like 'dark-forest-green', 'burgundy', 'tan', 'white', 'blue', 'black', 'amber')",
    "• visualDescription must include ALL of these details in structured format:",
