...
async function analyzeBatchViaVision(
  ...
  const prompt = [
    ...
    "For EVERY image also include quick insights: hasVisibleText (true/false), dominantColor (SPECIFIC color like 'dark-green', 'bright-pink', 'tan', 'beige', 'forest-green', 'burgundy', etc.), role (front, back, side, detail, accessory, packaging, other), textExtracted (ALL visible text you can read), and visualDescription (DETAILED description of what you see - be VERY specific about shapes, packaging type, colors, layout, text placement, etc.).",
    ...
    "",
    "CRITICAL FOR visualDescription - PROVIDE MAXIMUM DETAIL:",
    "Describe EVERYTHING you see in the image as if you were explaining it to another AI that needs to match it with other images. Ignore hands holding the product.",
    "Include ALL of the following details:",
    "1. PACKAGING TYPE: Exactly what form is it? (resealable pouch, stand-up pouch, plastic bottle, glass bottle, cylindrical tube, rectangular box, jar, canister, sachet, squeeze tube, pump bottle, spray bottle, blister pack, etc.)",
    "2. SHAPE & DIMENSIONS: What's the physical shape? (tall and narrow, short and wide, square, oval, rectangular with rounded corners, flat pouch, bulging pouch, etc.)",
    "3. MATERIAL & FINISH: What's it made of? (glossy plastic, matte plastic, metallic foil, paper label, transparent plastic, frosted glass, smooth surface, textured surface, etc.)",
    "4. PRIMARY COLORS: List ALL visible colors with SPECIFIC shades (not just 'green' but 'dark forest green', 'lime green accent', 'olive green border', etc.)",
    "5. BACKGROUND COLORS: What color is the main packaging background?",
    "6. TEXT COLORS: What colors are used for text? (white text, black text, silver text, gold text, color gradients, etc.)",
    "7. TEXT LAYOUT: How is text arranged? (vertical text down the center, horizontal text across top, diagonal banner, text in multiple sections, text in boxes/panels, wraparound text, etc.)",
    "8. LOGOS & GRAPHICS: Describe any logos, icons, graphics, illustrations, photos, patterns, borders, frames, badges, seals",
    "9. PANELS & SECTIONS: What distinct areas/panels exist? (front panel with logo, side panel with barcode, supplement facts table, nutrition facts grid, ingredient list section, directions panel, warning section, etc.)",
    "10. TEXT SIZE & STYLE: What's prominent vs small? (large bold brand name at top, medium product name in center, small fine print at bottom, ALL CAPS sections, italic disclaimers, etc.)",
    "11. SPECIAL FEATURES: Any unique visual elements? (transparent window showing product, embossed logo, holographic foil, tear notch, zip lock, tamper seal, hanging hole, etc.)",
    "12. DISTINCTIVE MARKS: Anything that makes THIS specific product recognizable? (specific tagline, unique color combination, particular graphic style, recognizable pattern, signature design element, etc.)",
    "",
    "Example GOOD visualDescription: 'Dark forest green resealable stand-up pouch with glossy finish. Rectangular shape, approximately 8x10 inches when standing. Front panel: Large white bold text \"PERFORMANCE GREENS + PROTEIN\" arranged vertically in center. Brand logo \"FROG FUEL\" in white at top. Bright yellow accent banner across bottom with \"LEMON LIME\" in black text. Small white text claims scattered around edges: \"CAFFEINE FREE\", \"25g PROTEIN\", \"PROBIOTICS\". Background has subtle texture pattern. Metallic silver tear notch at top. Back panel would show: white supplement facts table in upper half, ingredients list in middle section, directions in lower section, barcode at bottom right corner.'",
    "",
    "Example BAD visualDescription: 'Green pouch with text.'",
    "",
