...
async function analyzeBatchViaVision(
  ...
  const prompt = [
    ...
    "",
    "STEP B — Fallback to Visible Logo / Brand on Back:",
    "• If you cannot find a manufacturer/distributor block:",
    "  - Look for any clear brand/logotype visible on the back",
    "  - A repeated brand name that also appears on the front",
    "  - A distinctive logo word near the top or center",
    "• Use that as the brand ONLY if it clearly looks like a brand (company or product line), NOT an ingredient.",
    "",
